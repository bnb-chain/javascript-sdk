...
<dd></dd>
<dt><a href="#DefaultSigningDelegate">DefaultSigningDelegate</a> ⇒ <code><a href="#Transaction">Transaction</a></code></dt>
<dd><p>The default signing delegate which uses the local private key.</p>
</dd>
<dt><a href="#LedgerSigningDelegate">LedgerSigningDelegate</a> ⇒ <code>function</code></dt>
<dd><p>The Ledger signing delegate.</p>
</dd>
...
* [BncClient](#BncClient)
    * [new BncClient(Binance)](#new_BncClient_new)
    * [.transfer(fromAddress, toAddress, amount, asset, memo, sequence)](#BncClient+transfer)
    * [.placeOrder(address, symbol, side, price, quantity, sequence, timeinforce)](#BncClient+placeOrder)
    * [._sendTransaction(concrete, stdSignMsg, address, sequence, memo, sync)](#BncClient+_sendTransaction) ⇒ <code>Object</code>
    * [.getBalance(address)](#BncClient+getBalance)
    * [.getAccount(address)](#BncClient+getAccount)
    ...
    * [.recoverAccountFromMneomnic(mneomnic)](#BncClient+recoverAccountFromMneomnic)
    * [.recoverAccountFromPrivateKey(privateKey)](#BncClient+recoverAccountFromPrivateKey)
    * [.checkAddress(address)](#BncClient+checkAddress) ⇒ <code>Boolean</code>

<a name="new_BncClient_new"></a>

### new BncClient(Binance)
...
<a name="BncClient+recoverAccountFromMneomnic"></a>
...
## DefaultSigningDelegate ⇒ [<code>Transaction</code>](#Transaction)
...
## LedgerSigningDelegate ⇒ <code>function</code>
...
| Param | Type |
| --- | --- |
| ledgerApp | [<code>LedgerApp</code>](#LedgerApp) | 
