...
function () {
  ...
  _createClass(Transaction, [{
    ...
    value: function serializePubKey(privateKey) {
      ...
      var pubKey = Buffer.concat([_varint.UVarInt.encode(format), unencodedPubKey.x.toArrayLike(Buffer, 'be', 32)]); //prefixed with length;
    ...
    value: function serialize() {
      ...
      var msg = this.msgs[0]; // msg = Object.assign({ version: 0x1 }, msg);
